        ...
        <section class="description">
            <div class="container-min">
                ...
                <div class="text">
                    ...
                    <ul>
                        <li>
                            <p>Вы самостоятельно ведете аккаунт и хотите оптимизировать его с целью увеличения
                                эффективности</p>
                        </li>
                        <li>
                            <p>Вы хотите более детально разобраться как работать с уже настроенной рекламной
                                кампанией</p>
                        </li>
                        <li>
                ...
                <div class="text">
                    ...
                    <ul>
                        <li>
                            <p>Вы получите подробный визуальный отчет, где допущены ошибки, как их исправить и к каким
